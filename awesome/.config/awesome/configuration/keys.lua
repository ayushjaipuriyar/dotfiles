...
--- Global key bindings
--- ~~~~~~~~~~~~~~~~~~~
awful.keyboard.append_global_keybindings({ --- App
	--- ~~~
	-- Terminal
	...
	awful.key({}, "XF86Calculator", function()
		awful.spawn.easy_async_with_shell(power_on_cmd, function(stdout) end)
	end, {
		description = "Turn on bluetooth",
		group = "hotkeys",
	}),
	awful.key({ shift }, "XF86Calculator", function()
		awful.spawn.easy_async_with_shell(power_off_cmd, function(stdout) end)
	end, {
		description = "Turn off bluetooth",
		group = "hotkeys",
	}),
	awful.key({ ctrl }, "XF86Calculator", function()
		awful.spawn.easy_async_with_shell("bluetoothctl connect 74:45:CE:24:42:52", function(stdout) end)
		awful.spawn.easy_async_with_shell("bluetoothctl connect F4:73:35:1E:61:16", function(stdout) end)
		awful.spawn.easy_async_with_shell("bluetoothctl connect FC:58:FA:08:55:7A", function(stdout) end)
		awful.spawn.easy_async_with_shell("bluetoothctl connect 4C:53:FD:B1:54:75", function(stdout) end)
		awful.spawn.easy_async_with_shell("bluetoothctl connect 28:6F:40:27:6B:25", function(stdout) end)
	end, {
		description = "Connect all bluetooth devices",
		group = "hotkeys",
	}), --- Power Pr--- Power Profile
	awful.key({}, "XF86Launch4", function()
		awful.spawn("sh /home/ayush/.config/rofi/applets/android/powermenu.sh")
	end, {
	...
	awful.key({ mod }, "grave", function()
		...
		description = "open music client",
		group = "hotkeys",
	}), --- Mounting Rclone drives
	awful.key({ mod }, "o", function()
		awful.spawn.with_shell(
			"rclone --vfs-cache-mode writes mount onedrive: ~/onedrive --buffer-size 256M --dir-cache-time 72h --drive-chunk-size 32M --log-level INFO --log-file /home/ayush/.logs/rclone-onedrive.log --vfs-read-chunk-size 128M --vfs-read-chunk-size-limit off"
		)
		awful.spawn.with_shell(
			"rclone --vfs-cache-mode writes mount drive: ~/drive --buffer-size 256M --dir-cache-time 72h --drive-chunk-size 32M --log-level INFO --log-file /home/ayush/.logs/rclone-gdrive.log --vfs-read-chunk-size 128M --vfs-read-chunk-size-limit off"
		)
		awesome.emit_signal("button::bluetooth:check")
	end, {
		description = "Mount Onedrive and Google Drive",
		group = "hotkeys",
	}),
	awful.key({ mod, shift }, "o", function()
		awful.spawn.with_shell("umount $HOME/onedrive")
		awful.spawn.with_shell("umount $HOME/drive")
		awesome.emit_signal("button::bluetooth:check")
	end, {
		description = "Mount Onedrive and Google Drive",
		group = "hotkeys",
	...
	awful.key({}, "XF86AudioRaiseVolume", function()
		...
		awesome.emit_signal("button::update")
	end, {
	...
	awful.key({ alt, shift }, "bracketright", function()
		playerctl_daemon:play_pause()
	end, {
		description = "play pause music",
		group = "hotkeys",
	}),
	awful.key({ alt, shift }, "bracketleft", function()
		playerctl_daemon:previous()
	end, {
		description = "previous music",
		group = "hotkeys",
	}),
	awful.key({ alt, shift }, "backslash", function()
	...
	awful.key({}, "XF86AudioPause", function()
		playerctl_daemon:pause()
	end, {
		description = "play music",
		group = "hotkeys",
	}),
	awful.key({}, "XF86AudioPlay", function()
		playerctl_daemon:play()
	end, {
...
--- Layout
--- ~~~~~~
awful.keyboard.append_global_keybindings({ --- Set tilling layout
...
awful.keyboard.append_global_keybindings({
	awful.key({ mod }, "bracketleft", awful.tag.viewprev, {
		description = "view previous",
		group = "tags",
	}),
	awful.key({ mod }, "bracketright", awful.tag.viewnext, {
...
-- awful.mouse.append_global_mousebindings({ --- Right click
-- 	awful.button({
-- 		modifiers = {},
-- 		button = 3,
-- 		on_press = function()
