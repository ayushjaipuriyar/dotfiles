...
--- Modern Top Panel
--- ~~~~~~~~~~~~~~~~~~~
local bluetooth = require("ui.panels.top-panel.bluetooth")
return function(s)
	--- Widgets
	--- ~~~~~~~~~~
	...
	s.spotify = require("ui.panels.top-panel.spotify")()
	s.slider = require("ui.panels.top-panel.slider")
